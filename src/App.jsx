    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          <img className="mb-7" src= {iconSedans} alt="icone dos carros sedans" />
          ...
          <a className="font-lexend bg-offwhitebg block w-fit px-10 py-3 rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg" href="https://www.webmotors.com.br/sedans" 
          target="_blank"> Ver mais</a>
        </div>

        <div className="bg-green p-12">
          <img className="mb-7" src= {iconSuvs} alt="icone dos carros suvs" />
          ...
          <a className="font-lexend bg-offwhitebg block w-fit px-10 py-3 rounded-3xl text-green border-2 border-offwhitebg hover:bg-green hover:text-offwhitebg" href="https://www.webmotors.com.br/suvs"
          target="_blank" >Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg ">
          ...
          <a className="font-lexend bg-offwhitebg block w-fit px-10 py-3 rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg" href="https://www.webmotors.com.br/carros-de-luxo"
          target="_blank" >Ver mais</a>
        </div>
      </section>
    </main>
