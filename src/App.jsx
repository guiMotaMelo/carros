    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a className="font-lexend bg-offwhitebg block w-fit px-10 py-3 rounded-3xl text-orange" href="https://www.webmotors.com.br/sedans" 
        ...
        <div className="bg-green p-12">
          ...
          <a className="font-lexend bg-offwhitebg block w-fit px-10 py-3 rounded-3xl text-green" href="https://www.webmotors.com.br/suvs"
          target="_blank" >Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend bg-offwhitebg block w-fit px-10 py-3 rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo"
          target="_blank" >Ver mais</a>
        </div>
      </section>
    </main>
